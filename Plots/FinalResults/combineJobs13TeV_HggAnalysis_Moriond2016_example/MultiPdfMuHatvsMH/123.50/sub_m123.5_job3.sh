#!/bin/bash
touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/123.50/sub_m123.5_job3.sh.run
...
if ( combine CMS-HGG_mva_13TeV_datacardMuScan.root  -M MultiDimFit --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo migrad --algo=grid  -P r --points=500 --firstPoint=150 --lastPoint=199 -n MuScanJob3 --setPhysicsModelParameterRanges r=-5.00,5.00  -m 123.50 ) then
	 ...
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/123.50/sub_m123.5_job3.sh.done
else
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/123.50/sub_m123.5_job3.sh.fail
fi
rm -f /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/123.50/sub_m123.5_job3.sh.run
cd -
