#!/bin/bash
touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/121.00/sub_m121_job0.sh.run
...
if ( combine CMS-HGG_mva_13TeV_datacardMuScan.root  -M MultiDimFit --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo migrad --algo=grid  -P r --points=500 --firstPoint=0 --lastPoint=49 -n MuScanJob0 --setPhysicsModelParameterRanges r=-5.00,5.00  -m 121.00 ) then
	 ...
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/121.00/sub_m121_job0.sh.done
else
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/121.00/sub_m121_job0.sh.fail
fi
rm -f /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/121.00/sub_m121_job0.sh.run
cd -
