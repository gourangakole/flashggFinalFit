#!/bin/bash
touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfChannelCompatibility/TTH/sub_m125.09_job0.sh.run
...
cp -p /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/CMS-HGG_mva_13TeV_datacard_TTHLeptonicTag_13TeV_TTHHadronicTag_13TeVMuScan.root .
...
if ( combine CMS-HGG_mva_13TeV_datacard_TTHLeptonicTag_13TeV_TTHHadronicTag_13TeVMuScan.root  -M MultiDimFit --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo migrad --algo=grid  -P r --points=100 --firstPoint=0 --lastPoint=99 -n MuScanJob0 --setPhysicsModelParameterRanges r=-10.00,10.00  -m 125.09 ) then
	 mv higgsCombine*.root /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfChannelCompatibility/TTH
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfChannelCompatibility/TTH/sub_m125.09_job0.sh.done
else
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfChannelCompatibility/TTH/sub_m125.09_job0.sh.fail
fi
rm -f /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfChannelCompatibility/TTH/sub_m125.09_job0.sh.run
cd -
