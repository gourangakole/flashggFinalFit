#!/bin/bash
touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/130.00/sub_m130_job2.sh.run
...
if ( combine CMS-HGG_mva_13TeV_datacardMuScan.root  -M MultiDimFit --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo migrad --algo=grid  -P r --points=500 --firstPoint=100 --lastPoint=149 -n MuScanJob2 --setPhysicsModelParameterRanges r=-5.00,5.00  -m 130.00 ) then
	 ...
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/130.00/sub_m130_job2.sh.done
else
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/130.00/sub_m130_job2.sh.fail
fi
rm -f /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/MultiPdfMuHatvsMH/130.00/sub_m130_job2.sh.run
cd -
