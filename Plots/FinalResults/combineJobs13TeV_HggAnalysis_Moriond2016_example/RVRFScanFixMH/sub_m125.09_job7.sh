#!/bin/bash
touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/RVRFScanFixMH/sub_m125.09_job7.sh.run
...
if ( combine CMS-HGG_mva_13TeV_datacardRVRFScan.root  -M MultiDimFit --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo migrad --algo=grid  -P RV -P RF --floatOtherPOIs=1 --points=4000 --firstPoint=280 --lastPoint=319 -n RVRFScanJob7 --setPhysicsModelParameterRanges RV=-3.00,10.00:RF=-2.00,3.50  -m 125.09 ) then
	 ...
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/RVRFScanFixMH/sub_m125.09_job7.sh.done
else
	 touch /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/RVRFScanFixMH/sub_m125.09_job7.sh.fail
fi
rm -f /afs/cern.ch/work/g/gkole/Hgg/finalfit/CMSSW_7_1_5/src/flashggFinalFit/Plots/FinalResults/combineJobs13TeV_HggAnalysis_Moriond2016_example/RVRFScanFixMH/sub_m125.09_job7.sh.run
cd -
